...
function abrirModalEditar(id){
  ...
  axios.post('/admin/get_areagestion',{'id': id })
      .then((response) => {	
...
function enviarModalEditar(){
  var linea_id = document.getElementById('linea_id').value;
      ...
      axios.post('/admin/update_areagestion', formData, {  
       })
       .then((response) => {	
         loadingOverlay().cancel(spinHandle); // cerrar loading            
    ...
    function enviarModalAgregar(){
      ...
      axios.post('/admin/add_areagestion', formData, {  
       })
       .then((response) => {	
         loadingOverlay().cancel(spinHandle); // cerrar loading            
...
function borrarareagestion(){
  ...
  axios.post('/admin/delete_areagestion',{
    'id': id  
      })
      .then((response) => {	
        loadingOverlay().cancel(spinHandle); // cerrar loading
